        ...
        @if($data != null)
            <div class="row">
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <h5>{{ $data->sub_sub_category_item->code ?? "-" }}</h5>
                            <h5>{{ $data->sub_sub_category_item->name ?? "-" }}</h5>
                            <h5>{{ $data->repository->name ?? "-" }}</h5>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <p class="mt-3">Catatan: Tidak dibenarkan memindahkan barang-barang yang ada pada daftar barang ini tanpa sepengetahuan pengurus barang pengugna / pengurus barang pembantu dan penanggungjawab ruangan.</p>
                </div>
            </div>
        @else
            <div class="row gy-4">
