    ...
    <div class="container position-relative">
      <div class="row gy-5" data-aos="fade-in">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center text-center text-lg-start">
          <h2>MAIN BASKET</h2>
          <p style="color: white;">Optimalisasi Sistem Informasi Inventarisasi Barang dan Aset berbasis QR Code, melalui Aplikasi <b> Manajemen Inventarisasi Barang dan Kelengkapan Aset ( MAIN BASKET ) </b></p>
