                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="mb-0">Edit Lantai</h5>
                        </div>
                        <div class="card-body">
                            <form action="/backoffice/floor" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="mb-3">
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control" name="building_name" id="building_name" value="{{ $data->building->name }}" disabled/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="div-exist-img-files" class="mb-3">
                                    @foreach($data->floor_images as $key=>$image)
