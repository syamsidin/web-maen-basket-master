                            ...
                            @foreach ($data as $key=>$item)
                                <tr>
                                    ...
                                    <td width="20%">
                                        ...
                                        <a href="/backoffice/edit-building/{{ $item->id }}" class="btn btn-sm btn-secondary">Edit</a>
...
<script>
    ...
    $(document).on('click', '.datatable-viewQR-btn', function(event) {
        ...
        $.ajax({
            type:'GET',
            url:`/backoffice/json/qr-code/building/${qr_data.id}/`,
