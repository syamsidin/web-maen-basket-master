                        ...
                        <tbody>
                            @foreach ($data as $key=>$item)
                                <tr>
                                    ...
                                    <td>{{ $item->year }}</td>
                                    <td>
                                        <span class="badge bg-dark">{{ $item->status->name }}</span>
                                    </td>
                                    <td width="20%">
                                        ...
                                        <a href="/backoffice/edit-not-used-item/{{ $item->id }}" class="btn btn-sm btn-secondary">Edit</a>
                                        <form id="delete-item-{{$item->id}}" action="/backoffice/not-used-item/{{ $item->id }}" method="POST" style="display:inline">
                                            @csrf
                                            @method('DELETE')
