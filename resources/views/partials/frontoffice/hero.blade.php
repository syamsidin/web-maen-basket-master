    ...
    <div class="container position-relative">
      <div class="row gy-5" data-aos="fade-in">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center text-center text-lg-start">
          {{-- <h2>MAIN BASKET</h2> --}}
          <h3 class="mb-5" style="color: white; font-size: 200%;">Optimalisasi Sistem Inventarisasi Barang dan Aset Berbasis QR Code melalui <b> Manajemen Inventarisasi Barang dan Kelengkapan Aset <br> ( MAIN BASKET ) </b></h3>
